sap.ui.define([
	...
	return Controller.extend("modi.controller.View2", {
        onBack: function(){
		...
		onF4Help: function(oEvent){
			...
			this.inputFieldIdonWhichF4inTableWasPressed = oEvent.getSource().getId();
		   	...
		   	if(this.cityPopup == null){
		   		//creating ALV object
			   	this.cityPopup = new sap.ui.xmlfragment("modi.fragments.Popup", this);
			   	//setting FC
		...
		onFilter: function(){
			//StatusMessage.show("This page is under construction...");
			this.countryPopup = new sap.ui.xmlfragment("modi.fragments.Popup", this);
